...
**Peau** : dark product console (canvas profond, surfaces graphite, ligne fine).
**Accent** : `#9fe8ff` — cold cyan. Console produit, trust, état technique.
**Classe body** : `xo-page xo-page--product`.

**Claims autorisés** : aide à réduire l'exposition, traitement local quand c'est vrai, absence de stockage des prompts originaux côté Paranoia quand c'est vrai, beta.
